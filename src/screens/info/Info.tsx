	...
	return (
		<animated.div className={styles.container} style={mountSpring}>
			<h1 className={styles.title}>
				Привет меня зовут Кирилл, я Junior Frontend Developer и это мое
				сайт-портфолио
			</h1>
			<h2 className={styles.subtitle}>Обо мне</h2>
			<div className={styles.text}>
				<p>
					Увлекаюсь программированием с 11 лет, обожая эту сферу. Уже около
					полугода занимаюсь веб разработкой поэтому почувствовал надобность в
					сайте-портфолио
				</p>
				<p>
